...
from helperComponents.drawingHelpers import Shape, distance
...
class Canvas(QWidget):
    ...
    def keyPressEvent(self, ev):
        ...
        elif key == Qt.Key_Delete and self.selectedShape:
            self.deleteShape.emit()
